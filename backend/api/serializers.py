...
class RecipeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'tags', 'author', 'ingredients',
                  'is_in_shopping_cart', 'is_favorited', 'name', 'image', 'text', 'cooking_time',
                  )
...
class IngredientAmountSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = RecipeIngredient  # Ваша промежуточная модель между рецептами и ингредиентами
        fields = ('id', 'amount')
class RecipeCreateSerializer(serializers.ModelSerializer):
    ...
    def create_ingredients(self, ingredients_data, recipe):
        ...
        for ingredient_data in ingredients_data:
            ...
            # Создаём объект RecipeIngredient
...
class SubscriptionSerializer(serializers.ModelSerializer):
    ...
    recipes = RecipeSerializer(many=True)  # Сериализатор для рецептов (предполагается, что он уже создан)
